 ...
 */
final class Version20210320124117 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD etablissement_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_67F068BCFF631228 ON commentaire');
        $this->addSql('ALTER TABLE commentaire DROP etablissement_id');
    }
}
